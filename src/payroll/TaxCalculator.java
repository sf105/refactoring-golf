...
public class TaxCalculator {
    private final TaxBand lowerTaxBand = new ChainedTaxBand(0.1, 5000, 1500, NIL_TAX_BAND);
    private final TaxBand middleTaxBand = new ChainedTaxBand(0.2, 20000, 4000, lowerTaxBand);
    private final TaxBand upperTaxBand = new ChainedTaxBand(0.4, 40000, 0, middleTaxBand);
